...
/// <param name="Country">Kartı çıkaran ülke (ISO-3166 alpha-2) — yurt dışı kart kuralları için.</param>
public sealed record BinInfo(
    string Bin, string BankCode, string BankName, string Program,
    string Brand, string CardType, bool IsCommercial, string Country);
